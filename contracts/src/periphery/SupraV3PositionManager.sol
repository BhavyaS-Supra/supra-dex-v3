...
contract SupraV3PositionManager is
    ISupraV3PositionManager,
    Multicall,
    ERC721Permit,
    ...
    SelfPermit
{
    ...
    /// @inheritdoc ISupraV3PositionManager
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721, IERC721Metadata) returns (string memory) {
        ...
        return ISupraV3PositionDescriptor(_tokenDescriptor).tokenURI(this, tokenId);
    }
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        ISupraV3Pool pool = ISupraV3Pool(PoolAddress.computeAddress(factory, poolKey));

...
import '@uniswap/v3-core/contracts/interfaces/ISupraV3Pool.sol';
import '@uniswap/v3-core/contracts/libraries/FixedPoint128.sol';
import '@uniswap/v3-core/contracts/libraries/TickMath.sol';
import '@uniswap/v3-core/contracts/libraries/Tick.sol';
import '../interfaces/ISupraV3PositionManager.sol';
...
library PositionValue {
    ...
    /// @param positionManager The Uniswap V3 SupraV3PositionManager
    ...
    function total(ISupraV3PositionManager positionManager, uint256 tokenId, uint160 sqrtRatioX96)
        internal
        view
    ...
    function principal(ISupraV3PositionManager positionManager, uint256 tokenId, uint160 sqrtRatioX96)
        internal
        view
        returns (uint256 amount0, uint256 amount1)
    {
    ...
    function fees(ISupraV3PositionManager positionManager, uint256 tokenId)
        internal
        view
        returns (uint256 amount0, uint256 amount1)
    {
    ...
    function _fees(ISupraV3PositionManager positionManager, FeeParams memory feeParams)
        private
        view
        returns (uint256 amount0, uint256 amount1)
    {
    ...
    function _getFeeGrowthInside(ISupraV3Pool pool, int24 tickLower, int24 tickUpper)
        private
        view

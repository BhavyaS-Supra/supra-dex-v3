...
import '@uniswap/v3-core/contracts/interfaces/callback/ISupraV3SwapCallback.sol';
...
contract QuoterV2 is IQuoterV2, ISupraV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for ISupraV3Pool;
    ...
    function uniswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes memory path) external view override {
        ...
        ISupraV3Pool pool = getPool(tokenIn, tokenOut, fee);
    ...
    function handleRevert(bytes memory reason, ISupraV3Pool pool, uint256 gasEstimate)
        private
        view
        ...
        returns (uint256 amountOut, uint160 sqrtPriceX96After, uint32 initializedTicksCrossed, uint256 gasEstimate)
    {
        ...
        ISupraV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);

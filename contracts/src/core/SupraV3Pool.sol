...
import './interfaces/ISupraV3Pool.sol';
...
import './interfaces/ISupraV3PoolDeployer.sol';
import './interfaces/ISupraV3Factory.sol';
import './interfaces/IERC20Minimal.sol';
import './interfaces/callback/ISupraV3MintCallback.sol';
import './interfaces/callback/ISupraV3SwapCallback.sol';
import './interfaces/callback/ISupraV3FlashCallback.sol';

contract SupraV3Pool is ISupraV3Pool, NoDelegateCall {
    ...
    /// @inheritdoc ISupraV3PoolImmutables
    ...
    /// @dev Prevents calling a function from anyone except the address returned by ISupraV3Factory#owner()
    modifier onlyFactoryOwner() {
        require(msg.sender == ISupraV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = ISupraV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc ISupraV3PoolDerivedState
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        ISupraV3MintCallback(msg.sender).uniswapV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            ISupraV3SwapCallback(msg.sender).uniswapV3SwapCallback(amount0, amount1, data);
        ...
        noDelegateCall
    {
        ...
        ISupraV3FlashCallback(msg.sender).uniswapV3FlashCallback(fee0, fee1, data);
